...
import { oneGuarantor, displayCandidate } from '../store/actions/verificationAction';
import Nav from '../Nav';
...
const mapStateToProps = (state) => {
    //console.log('guarantor ibfo', state.verification.oneGuarantor);
    return {
